...
module.exports = {
  dev: {
    ...
    proxyTable: {
      ...
      // '/game': {
      //   target: 'http://test-mmath.classba.cn/',
      //   secure: false,
      //   changeOrigin: true,
      // }
    },
    ...
    host: 'me.classba.cn', // can be overwritten by process.env.HOST
    // host: 'localhost', // can be overwritten by process.env.HOST
    // host: '10.173.1.188', // can be overwritten by process.env.HOST
